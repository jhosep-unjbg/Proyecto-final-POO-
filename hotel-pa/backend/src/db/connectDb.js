...
exports.connectDbIfEnabled = connectDbIfEnabled;
var data_source_1 = require("./data-source");
function connectDbIfEnabled() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    enabled = ((_a = process.env.DB_ENABLED) !== null && _a !== void 0 ? _a : "false") === "true";
                    if (!enabled) {
                ...
                case 3:
                    err_1 = _b.sent();
                    console.error(" Error conectando DB:", err_1);
